...
import { useModalAdicionarInformacaoFacade } from "../hooks/useModalAdicionarInformacaoFacade";
...
export function ModalAdicionarInformacao({
  ...
  } = useModalAdicionarInformacaoFacade({ onClose, isOpen });
                    ...
                    {pessoaSelecionada && (
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          ...
                          <button
                            type="button"
                            onClick={() => limparPessoaSelecionada()}
